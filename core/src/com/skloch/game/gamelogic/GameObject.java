...
/**
 * An object that stores a position and dimensions, but can also store extra properties when loaded
 * from a tilemap. Player can interact and trigger events with these objects.
 */
