...
public class NPC {
    ...
    /**
     * Sets the NPC's state to moving or not moving, a not moving character will just display an
     * idle animation.
     *
    ...
    /**
     * Sets the x coordinate of the NPC, updating all 3 hitboxes at once as opposed to just the
     * sprite rectangle.
     */
    ...
    /**
     * Sets the Y coordinate of the NPC, updating all 3 hitboxes at once as opposed to just the
     * sprite rectangle.
     */
