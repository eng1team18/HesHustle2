...
public class AssetTests {
  ...
  public void testIfEastCampusTexturesExists() {
    assertTrue(
        Gdx.files.internal("../assets/East Campus/Textures/StarRealmsCozyForestPack24x24.png")
            .exists());
  }
  ...
  public void testIfEastCampusTilemapsExists() {
    assertTrue(
        Gdx.files.internal("../assets/East Campus/Tilemaps/StarRealmsCozyForestPack24x24.tsx")
            .exists());
  }
  ...
  public void testIfInterfaceBlockyInterfaceDataExists() {
    ...
    assertTrue(Gdx.files.internal("../assets/Interface/BlockyInterface_data/button_disabled.9.png")
        .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/button_over.9.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/button_up.9.png").exists());
    assertTrue(Gdx.files.internal("../assets/Interface/BlockyInterface_data/MotorolaScreentype.fnt")
        .exists());
    assertTrue(Gdx.files.internal("../assets/Interface/BlockyInterface_data/MotorolaScreentype.png")
        .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/nk57-monospace.rg-bold.png")
            .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/nk57-monospace.rg-bold.fnt")
            .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/PixeloidMono edited(2).png")
            .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/PixeloidMono edited(2).fnt")
            .exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/scroll_bar.9.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/scroll_bar_v.9.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/slider_bar.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/slider_button.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/window.9.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/scroll_bar.9.png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/W95FA(3).png").exists());
    assertTrue(
        Gdx.files.internal("../assets/Interface/BlockyInterface_data/W95FA(3).fnt").exists());
  }
